...
namespace KurumsalWeb.Controllers
{
    public class İletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "İletisimId,Adres,Telefon,Fax,Whatsapp,Instagram")] İletisim İletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "İletisimId,Adres,Telefon,Fax,Whatsapp,Instagram")] İletisim İletisim)
        {
            if (ModelState.IsValid)
            {
