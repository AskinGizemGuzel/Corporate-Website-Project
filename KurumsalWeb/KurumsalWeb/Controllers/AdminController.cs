    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult SifremiUnuttum(string eposta)
        {
            ...
            if (mail != null)
            {
                ...
                WebMail.UserName = "agizemb@gmail.com";
                WebMail.Password = "Bguzel1919!";
                WebMail.SmtpPort = 587;
                WebMail.Send(eposta, "Admin Panel Giriş Şifreniz", "Şifreniz:" + yenisifre);
                ViewBag.Uyari = "Şifreniz Başarı İle Gönderilmiştir!";
            }
            else
            {
                ViewBag.Uyari = "Şifreniz Gönderilememiştir.Tekrar Deneyiniz!";
            }
            return View();
        }
